...
public class InfoService {
	...
	public HashMap<String,Object> loginCheck(HashMap<String,String> map){
		...
		System.out.println(">>>>>>>>loginCheck Service called");
		return infoDAO.loginCheck(map);
	}
	
	public List<HashMap<String, Object>> getUser(HashMap<String,String> map){
		//학생 개인정보와 학생 이력정보를 따로 가지고온다.
		
		System.out.println(">>>>>>>>getUser Service called");
		
		//학생 개인정보
		List<HashMap<String, Object>> studentInfo = infoDAO.getUserBasic(map);
		//학생 이력 개수
		HashMap<String,String> studentExpCount = infoDAO.getUserExpCount(map);
